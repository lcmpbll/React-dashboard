      ...
      <Box display='flex' justifyContent='space-between' alignItems='center'>
        <Header title='DASHBOARD' subtitle="Welcome to your dashboard"/>
          ...
          <Box display='grid' gridTemplateColumns='repeat( 12, 1fr)' gridAutoRows='140px' gap='20px'>
            ...
            <Box gridColumn='span 3' backgroundColor={colors.primary[400]} display='flex' alignItems='center' justifyContent='center'>
              <StatBox 
                title='431,225' subtitle='Sales Obtained' progress='0.80' increase='+43%' icon={<PointOfSaleIcon sx={{ color: colors.greenAccent[600], fontSize: '26px'}} /> }
              />
            </Box>
            <Box gridColumn='span 3' backgroundColor={colors.primary[400]} display='flex' alignItems='center' justifyContent='center'>
              <StatBox 
                title='32,344' subtitle='New Clients' progress='0.30' increase='+5%' icon={<PersonAddIcon sx={{ color: colors.greenAccent[600], fontSize: '26px'}} /> }
              />
            </Box>
            <Box gridColumn='span 3' backgroundColor={colors.primary[400]} display='flex' alignItems='center' justifyContent='center'>
              <StatBox 
                title='100,601' subtitle='Site Traffic' progress='0.95' increase='+57%' icon={<TrafficIcon sx={{ color: colors.greenAccent[600], fontSize: '26px'}} /> }
              />
            </Box>
                ...
                {mockTransactions.map((transaction, i)=> (
                  <Box 
                    ...
                    padding='15px'>
                      ...
                      <Box backgroundColor={colors.greenAccent[500]} p='5px 10px' borderRadius='5px'>${transaction.cost}</Box>
                    </Box>
                  ))}
                </Box>
                {/* Row Three */}
